...
3. Work in your editor and create the code for the exercise. 
   * In the folder `exercises` in the root of the project, you will find folders named `day01` to `day12`.
...
And if you are stuck, write an issue in the upstream project: https://github.com/Friends-of-AoC/Advent-of-Code-2025-exchange/issues
